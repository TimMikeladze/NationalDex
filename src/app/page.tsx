...
function HomeContent() {
  ...
  return (
    <div>
      ...
      <div className="sticky top-0 z-30 border-b px-4 md:px-6 py-3 lg:top-14 pwa-sticky-toolbar relative bg-background lg:bg-background/95 lg:backdrop-blur lg:supports-[backdrop-filter]:bg-background/80">
        <DexFilter
          filter={filter}
