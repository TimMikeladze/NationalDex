...
/**
 * The interactive dex: filter toolbar plus the virtualized Pokemon grid and the
 * move/ability/item lists. Rendered by the server component in `page.tsx`,
 * which supplies the crawlable heading, copy and link index around it.
 */
